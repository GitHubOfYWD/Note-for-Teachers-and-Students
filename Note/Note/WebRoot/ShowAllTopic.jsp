		...
		<div class="center_box">
			...
			<div class="left_content_myhome">
            	<div class="calendar_box_myhome">
                	 ...
                	 <p><span><font size="4" color="red">所有讨论话题</font></span><br>
                	 <s:iterator value="ht" status="satt">
						<s:a href="topic_VisitTopic.action?username=%{username}&password=%{password}&topic=%{topic}&host=%{host}"><s:property value="topic"/></s:a> <br class="spacer" />
					</s:iterator>
					</p>
					<br/>
					<br/>
